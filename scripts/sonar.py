...
def main(session):
    ...
    print "Front:", memory_service.getData("Device/SubDeviceList/Platform/Front/Sonar/Sensor/Value")

    # Same thing for right.
    print "Back:", memory_service.getData("Device/SubDeviceList/Platform/Back/Sonar/Sensor/Value")
